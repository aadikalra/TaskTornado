...
const TOUR_STEPS: TourStep[] = [
    {
        ...
        description: 'The Dock gives you quick access to everything — your classes, calendar, AI assistant, and more. It stays with you on every page.',
        position: 'top',
    },
    {
        target: 'search',
        title: 'Command Palette',
        description: 'Press ⌘K (or Ctrl+K) to instantly search across classes, homework, and tools. It\'s the fastest way to navigate.',
        position: 'top',
    },
    {
        target: 'aurora',
        title: 'Meet Aurora',
        description: 'Your AI study companion. Ask questions, generate flashcards, take quizzes, get homework help — Aurora can do it all.',
        position: 'top',
    },
    {
        target: 'classes',
        title: 'Your Classes',
        description: 'All your classes, homework, and tests live here. Add classes, track assignments, pin important tasks, and stay on top of due dates.',
        position: 'top',
