...
const SplittingText: React.FC<SplittingTextProps> = ({
  ...
  alternateColors, // Destructure here
  ...props
}) => {
  ...
  const getAlternateColor = (index: number, colors: [string, string]): string => {
              ...
              <motion.span
                ...
                style={{
                  ...
                  color: alternateColors
                    ? getAlternateColor(globalIndex + ci, alternateColors)
                    : undefined
                }}
              >
                {ch}
