...
export default function EditHomeworkPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-6">
        <Link href={`/homework/${id}`} className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900 mb-6">
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to Homework
        </Link>
        
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Edit Homework</h1>
      </div>
