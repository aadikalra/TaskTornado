...
const tutorialsData: Tutorial[] = [
  ...
  },
  {
    ...
    description: 'Master your academic workflow with Aurora—the supportive, data-aware assistant designed to help you study smarter.',
    category: 'Features',
    difficulty: 'beginner',
    tags: ['ai', 'aurora', 'automation', 'productivity'],
    href: '/tutorials/aurora-assistant'
  },
  {
    id: 'changelog',
    title: `Version ${BUILD_VERSION} Update`,
