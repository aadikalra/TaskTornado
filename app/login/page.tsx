            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="relative inline-block w-full">
                  <span className="absolute z-10 -top-2 -right-2 rotate-12 bg-pink-500 text-white text-[10px] px-1.5 py-0.5 rounded-md shadow">
                    BETA
                  </span>
                  <button
                    disabled
                    type="button"
                    aria-label="Continue with Google (beta)"
                    className={`w-full flex justify-center items-center py-3.5 px-4 border border-gray-200 dark:border-gray-600 rounded-xl shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 opacity-50 cursor-not-allowed`}
                  >
