...
export const TIER_LIMITS = {
    free: {
        ...
        aiDeepPerDay: 0,
        aiCloudPerDay: 0,
        aiQuizGenPerDay: 0,     // 1/week handled separately
        aiFlashcardGenPerDay: 0, // 1/week handled separately
        aiQuizGenPerWeek: 1,
        aiFlashcardGenPerWeek: 1,
        // Translation
    ...
    family: {
        ...
        aiDeepPerDay: 50,
        aiCloudPerDay: 20,
        aiQuizGenPerDay: Infinity,
        aiFlashcardGenPerDay: Infinity,
        aiQuizGenPerWeek: Infinity,
        aiFlashcardGenPerWeek: Infinity,
